...
/* function: LoadManagedLibrary */
static int tolua_lua_server_LoadManagedLibrary00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  void* tolua_var_1 = ((void*)  tolua_touserdata(tolua_S,1,0));
 {
  void* tolua_ret = (void*)  LoadManagedLibrary(tolua_var_1);
 tolua_pushuserdata(tolua_S,(void*)tolua_ret);
 }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'LoadManagedLibrary'.",&tolua_err);
 return 0;
#endif
}

/* function: ThreadLoadManageLibrary */
static int tolua_lua_server_ThreadLoadManageLibrary00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'ThreadLoadManageLibrary'.",&tolua_err);
 return 0;
#endif
}
...
static int tolua_lua_server_Logger_toHex00(lua_State* tolua_S)
{
 ...
 {
  Logger* self = (Logger*)  tolua_tousertype(tolua_S,1,0);
  unsigned int tolua_var_3 = ((unsigned int)  tolua_tonumber(tolua_S,2,0));
  int len = ((int)  tolua_tonumber(tolua_S,3,0));
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in function 'toHex'",NULL);
#endif
 {
  char* tolua_ret = (char*)  self->toHex(tolua_var_3,len);
 tolua_pushstring(tolua_S,(const char*)tolua_ret);
 }
 }
 return 1;
...
/* function: ServerLog */
static int tolua_lua_server_ServerLog00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'ServerLog'.",&tolua_err);
 return 0;
#endif
}
...
#endif
 {
  int tolua_var_4 = ((int)  tolua_tonumber(tolua_S,1,0));
 {
  sleep(tolua_var_4);
 }
 }
...
LUALIB_API int luaopen_lua_server (lua_State* tolua_S)
{
 ...
 tolua_function(tolua_S,"LoadManagedLibrary",tolua_lua_server_LoadManagedLibrary00);
 tolua_function(tolua_S,"ThreadLoadManageLibrary",tolua_lua_server_ThreadLoadManageLibrary00);
 ...
 tolua_function(tolua_S,"ServerLog",tolua_lua_server_ServerLog00);
